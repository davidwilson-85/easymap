...
if [ $analysis_type == 'snp' ]; then
	...
	if [ $snp_control == 'par' ]; then
		...
		{
			python simulator/sim-recsel.py -outdir $sim_recsel_output_folder_recessive -rec_freq_distr $rec_freq_distr -parmut $parmut_sample -parpol $parpol_sample -mutapos $mut_pos -smod r -nrec $nbr_rec_chrs 
		...
		{
			python simulator/sim-recsel.py -outdir $sim_recsel_output_folder_dominant -rec_freq_distr $rec_freq_distr -parmut $parmut_sample -parpol $parpol_sample -mutapos $mut_pos -smod wt -nrec $nbr_rec_chrs 
