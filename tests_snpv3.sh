...
./easymap -n BBI -w ins -r mid -sim -g complete.gff -sm 8 -i pbinprok2.fa -ss 5+100,0+500,100+1+50+pe
rm -rf ./user_projects/*/1_intermediate_files/sim_data/

./easymap -n BBI -w ins -r mid -sim -g complete.gff -sm 8 -i pbinprok2.fa -ss 15+100,0+500,100+1+50+pe
rm -rf ./user_projects/*/1_intermediate_files/sim_data/

./easymap -n BBI -w ins -r mid -sim -g complete.gff -sm 8 -i pbinprok2.fa -ss 5+100,0+500,100+1+50+se
rm -rf ./user_projects/*/1_intermediate_files/sim_data/

./easymap -n BBI -w ins -r mid -sim -g complete.gff -sm 8 -i pbinprok2.fa -ss 15+100,0+500,100+1+50+se
rm -rf ./user_projects/*/1_intermediate_files/sim_data/
