...
for i in range(len(mutated_positions)):
	...
	os.system("./easymap -n take_caso_3-"+$i+" -w snp -sim -r at4 -g chr1+4.gff -rs ref -cr oc -co par_mut -sm 80+e -sr 0,16-1,34-2,31-3,14-4,4-5,1+1,"+a+"+r+100 -ss 25+100,0+500,100+1+50+se")
	...
	os.system("./easymap -n take_caso_4"+$i+" -w snp -sim -r at4 -g chr1+4.gff -rs ref -cr oc -co par_nomut -sm 80+e -sr 0,16-1,34-2,31-3,14-4,4-5,1+1,"+a+"+r+100 -ss 25+100,0+500,100+1+50+se")
	...
	os.system("./easymap -n take_caso_6"+$i+" -w snp -sim -r at4 -g chr1+4.gff -rs noref -cr oc -co par_mut -sm 80+e -sr 0,16-1,34-2,31-3,14-4,4-5,1+1,"+a+"+r+100 -ss 25+100,0+500,100+1+50+se")
