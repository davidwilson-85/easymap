...
#./easymap -n caso6 -w snp -sim -r at -g complete.gff -rs noref -cr oc -co par_mut -sm 400+e -sr 0,26-1,42-2,25-3,5-4,1-5,1/0,24-1,43-2,25-3,6-4,1-5,1+1,400000+r+100 -ss 25+100,0+500,100+1+50+se
...
#./easymap -n caso4 -w snp -sim -r at -g complete.gff -rs ref -cr oc -co par_nomut -sm 400+e -sr 0,26-1,42-2,25-3,5-4,1-5,1/0,24-1,43-2,25-3,6-4,1-5,1+1,400000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso3 -w snp -sim -r at -g complete.gff -rs ref -cr oc -co par_mut -sm 400+e -sr 0,26-1,42-2,25-3,5-4,1-5,1/0,24-1,43-2,25-3,6-4,1-5,1+1,400000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso5 -w snp -sim -r at -g complete.gff -rs noref -cr bc -co f2wt -sm 400+e -sr 0,26-1,42-2,25-3,5-4,1-5,1/0,24-1,43-2,25-3,6-4,1-5,1+1,400000+r+100 -ss 25+100,0+500,100+1+50+se
./easymap -n caso2 -w snp -sim -r at -g complete.gff -rs ref -cr bc -co f2wt -sm 400+e -sr 0,26-1,42-2,25-3,5-4,1-5,1/0,24-1,43-2,25-3,6-4,1-5,1+1,400000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso1 -w snp -sim -r at -g complete.gff -rs ref -cr bc -co par_mut -sm 400+e -sr 0,26-1,42-2,25-3,5-4,1-5,1/0,24-1,43-2,25-3,6-4,1-5,1+1,400000+r+100 -ss 25+100,0+500,100+1+50+se
