...
./easymap -n caso1 -w snp -sim -r mini -g chr1+4.gff -rs ref -cr bc -co par_mut -sm 200+e -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,201324+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso2 -w snp -sim -r mini -g chr1+4.gff -rs ref -cr bc -co f2wt -sm 200+e -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,20104+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso3 -w snp -sim -r mini -g chr1+4.gff -rs ref -cr oc -co par_mut -sm 200+e -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso4 -w snp -sim -r mini -g chr1+4.gff -rs ref -cr oc -co par_nomut -sm 200+e -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,201324+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso6 -w snp -sim -r mini -g chr1+4.gff -rs noref -cr oc -co par_mut -sm 200+e -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se