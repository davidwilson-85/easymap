...
#./easymap -n caso1 -w snp -d sim -r mini -g chr1+4.gff -rs ref -cr bc -co par_mut -sm 100+e -sr 0,14-1,31-2,33-3,15-4,5-5,2/0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se
...
#./easymap -n caso5 -w snp -d sim -r mini -g chr1+4.gff -rs noref -cr bc -co f2wt -sm 500+e -sr 0,14-1,31-2,33-3,15-4,5-5,2/0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se
./easymap -n caso2 -w snp -d sim -r mini -g chr1+4.gff -rs ref -cr bc -co f2wt -sm 100+e -sr 0,14-1,31-2,33-3,15-4,5-5,2/0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso3 -w snp -d sim -r mini -g chr1+4.gff -rs ref -cr oc -co par_mut -sm 100+e -sr 0,14-1,31-2,33-3,15-4,5-5,2/0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso4 -w snp -d sim -r mini -g chr1+4.gff -rs ref -cr oc -co par_nomut -sm 100+e -sr 0,14-1,31-2,33-3,15-4,5-5,2/0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso6 -w snp -d sim -r mini -g chr1+4.gff -rs noref -cr oc -co par_mut -sm 100+e -sr 0,14-1,31-2,33-3,15-4,5-5,2/0,24-1,42-2,25-3,6-4,1-5,2+1,2010324+r+100 -ss 25+100,0+500,100+1+50+se