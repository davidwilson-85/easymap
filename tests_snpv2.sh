...
./easymap -n caso5 -w snp -sim -r at -g complete.gff -rs noref -cr bc -co f2wt -sm 300+e -sr 0,20-1,39-3,28-4,2-5,1+1,4000000+r+100 -ss 30+100,0+500,100+1+50+se
./easymap -n caso2 -w snp -sim -r at -g complete.gff -rs ref -cr bc -co f2wt -sm 300+e -sr 0,20-1,39-3,28-4,2-5,1+1,4000000+r+100 -ss 30+100,0+500,100+1+50+se
