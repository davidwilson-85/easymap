...
./easymap -n caso4 -w snp -sim -r 8mb -g complete.gff -mb ref -cr oc -co par_nomut -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso6 -w snp -sim -r 8mb -g complete.gff -mb noref -cr oc -co par_mut -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso1 -w snp -sim -r chr -g complete.gff -mb ref -cr bc -co par_mut -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
./easymap -n caso7 -w snp -sim -r chr -g complete.gff -mb noref -cr bc -co par_mut -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso5 -w snp -sim -r chr -g complete.gff -mb noref -cr bc -co f2wt -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
./easymap -n caso2 -w snp -sim -r chr -g complete.gff -mb ref -cr bc -co f2wt -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
...
./easymap -n caso3 -w snp -sim -r chr -g complete.gff -mb ref -cr oc -co par_mut -sm 300 -sr 0,24-1,42-2,25-3,6-4,1-5,2+1,4000000+r+100 -ss 25+100,0+500,100+1+50+se
