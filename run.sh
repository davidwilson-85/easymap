...
do
    ...
    #SAM to BAM
       {
			./samtools1/samtools view $i > alignment.bam 
		...
		{
			./samtools1/samtools mpileup -uf pbinprok2.fa alignment.bam | ./bcftools-1.3.1/bcftools call -c | ./bcftools-1.3.1/vcfutils.pl vcf2fq > cns.fq
		} || {
			echo $(date) ': Error ' 
