...
# If genome annotation file provided, merge that info with variants_info2 i a new list called
# 'variants_info_3'
else:
		...
		if hit_gene != 0:
			...
			for ann_gene in ann_array:
				...
				if hit_gene == ann_fields[0]:
					ann_result = ann_fields[1]
				
				if ann_result == None:
					ann_result = 'Gene not found in gene functional annotation source'
